    ...
    <footer className="bg-zinc-900 text-gray-300 py-10 mt-20 border-t border-zinc-800">
      <div className="container mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-6">
        ...
        <div className="text-center sm:text-left space-y-1">
          <h4 className="text-lg font-semibold">Sachin Kumar</h4>
          <p className="text-sm">© {new Date().getFullYear()} All rights reserved.</p>
          <p className="text-sm">Made with ❤️ by Sachin Kumar</p>
        </div>
        ...
        <div className="flex gap-6 text-sm">
          ...
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=Sachinkr272004@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-col items-center hover:text-blue-400 transition"
            title="Send Email"
